		...
		builder
			...
			.addSubcommand((subcommand) =>
				subcommand
					...
					.addStringOption((option) =>
						option
							.setName(t({ key: 'meeting-title', ns }))
							.setDescription(t({ key: 'meeting-title-description', ns }))
							.setNameLocalizations(localization('meeting-title', ns))
							.setDescriptionLocalizations(localization('meeting-title-description', ns))
							.setRequired(true)
					)
			)
			.addSubcommand((subcommand) =>
				subcommand
					...
					.addStringOption((option) =>
						option
							.setName(t({ key: 'thing', ns }))
							.setDescription(t({ key: 'thing-to-promote-to', ns }))
							.setNameLocalizations(localization('thing', ns))
							.setDescriptionLocalizations(localization('thing-to-promote-to', ns))
							.setRequired(true)
					)
					.addUserOption((option) =>
						option
